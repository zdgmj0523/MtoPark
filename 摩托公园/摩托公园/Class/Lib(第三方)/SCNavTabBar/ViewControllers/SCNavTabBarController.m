...
#pragma mark 背景的颜色
    ...
    _mainView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, _navTabBar.frame.origin.y + _navTabBar.frame.size.height, SCREEN_WIDTH, SCREEN_HEIGHT - _navTabBar.frame.origin.y - _navTabBar.frame.origin.y - STATUS_BAR_HEIGHT - NAVIGATION_BAR_HEIGHT)];
...
- (void)setNavTabbarColor:(UIColor *)navTabbarColor
{
    ...
    {
        navTabbarColor = [UIColor redColor];
    }
